...
sed -i "s/http:\/\/ozone-development.github.io\/iwc\/owf7adapter.html?url=http%3A%2F%2Fozone-development.github.io%2Fozp-demo/https:\/\/${HOST_IP}:7799\/iwc\/owf7adapter.html?url=https%3A%2F%2F${HOST_IP}%3A7799%2Fdemo_apps/g" modifiedListingData.json
