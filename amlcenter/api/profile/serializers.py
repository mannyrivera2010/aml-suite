...
import amlcenter.api.work_role.model_access as work_role_model_access
import amlcenter.api.image.model_access as image_model_access
from amlcenter.api.work_role.serializers import WorkRoleSerializer
from amlcenter.api.image.serializers import ImageSerializer
...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'display_name', 'bio', 'avatar', 'organizations',
            ...
            'leaving_aml_warning_flag', 'only_508_search_flag', 'is_beta_user', 'theme')
    ...
    def update(self, profile_instance, validated_data):
        ...
        if 'leaving_aml_warning_flag' in validated_data:
            profile_instance.leaving_aml_warning_flag = validated_data['leaving_aml_warning_flag']
