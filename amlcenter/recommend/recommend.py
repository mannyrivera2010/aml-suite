...
Website Link: https://github.com/aml-development/aml-documentation/wiki/Recommender-%282017%29
...
from amlcenter.recommend import recommend_es
...
class RecommenderProfileResultSet(object):
    ...
    def __init__(self, profile_id):
        """
        Usage:
            from amlcenter.api.storefront.model_access import RecommenderProfileResultSet;RecommenderProfileResultSet.from_profile_instance(Profile.objects.first()).process()
