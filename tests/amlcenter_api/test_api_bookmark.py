...
TEST_MODE=True pytest tests/amlcenter_api/test_api_bookmark.py
"""
from django.test import override_settings
from tests.aml.cases import APITestCase

from amlcenter.bookmark_helper import BookmarkFolder, BookmarkListing, shorthand_permissions
...
class BookmarkApiTest(APITestCase):
    ...
    What to test:
        look at the top of amlcenter.api.bookmark.model_access
    """
