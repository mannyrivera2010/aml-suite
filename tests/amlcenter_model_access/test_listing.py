...
class ListingTest(TestCase):
    ...
    def test_doc_urls_to_string_object(self):
        doc_urls = models.DocUrl.objects.filter(listing__unique_name='aml.test.air_mail')
    ...
    def test_screenshots_to_string_object(self):
        screenshots = models.Screenshot.objects.filter(listing__unique_name='aml.test.air_mail')
    ...
    def test_image_to_string_object(self):
        listing_banner_icon_id = models.Listing.objects.get(unique_name='aml.test.air_mail').banner_icon.id
