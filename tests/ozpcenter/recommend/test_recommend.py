...
class RecommenderTest(APITestCase):
    ...
    def test_recommendation_baseline_graph(self):
        ...
        expected_result = [{'_score': {'Baseline': {'raw_score': 8.0, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 13.0},
                            'title': 'White Horse'},
                           {'_score': {'Baseline': {'raw_score': 8.2, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 13.2},
                            'title': 'Navigation'},
                           {'_score': {'Baseline': {'raw_score': 8.5, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 13.5},
                            'title': 'Bleach'},
                           {'_score': {'Baseline': {'raw_score': 9.0, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 14.0},
                           ...
                           {'_score': {'Baseline': {'raw_score': 9.0, 'weight': 1.0},
                                       ...
                                       '_sort_score': 14.0},
                            'title': 'Stop sign'},
                           {'_score': {'Baseline': {'raw_score': 10.5, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 15.5},
                            'title': 'Killer Whale'},
                           {'_score': {'Baseline': {'raw_score': 11.5, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 16.5},
                            'title': 'Wolf Finder'},
                           {'_score': {'Baseline': {'raw_score': 11.5, 'weight': 1.0},
                                       'Bookmark Collaborative Filtering': {'raw_score': 2.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 21.5},
                            'title': 'Chart Course'}]
        # import pprint
    ...
    def test_recommendation_baseline(self):
        ...
        expected_result = [{'_score': {'Baseline': {'raw_score': 9.0, 'weight': 1.0},
                                     '_sort_score': 9.0},
                          'title': 'Bass Fishing'},
                         {'_score': {'Baseline': {'raw_score': 9.0, 'weight': 1.0},
                                     '_sort_score': 9.0},
    ...
    def test_recommendation_graph(self):
        ...
        expected_result = [{'_score': {'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                  'weight': 5.0},
                                       '_sort_score': 5.0},
                            'title': 'Acoustic Guitar'},
                           {'_score': {'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 5.0},
                            'title': 'Bleach'},
                           {'_score': {'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                           ...
                           {'_score': {'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 5.0},
                            'title': 'Screamin Eagle CVO'},
                           {'_score': {'Bookmark Collaborative Filtering': {'raw_score': 1.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 5.0},
                            'title': 'Snow'},
                           {'_score': {'Bookmark Collaborative Filtering': {'raw_score': 2.0,
                                                                            'weight': 5.0},
                                       '_sort_score': 10.0},
                            'title': 'Chart Course'}]
        # import pprint
