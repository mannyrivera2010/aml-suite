...
# Use case: developer working on ozp-center on host box, building on host box,
# needs to redeploy pre-built Center updates on VM.
...
sudo cp -r ${RSYNC_DIR}/ozp-center/dist/* ${STATIC_DEPLOY_DIR}/center
