...
from io import StringIO; from aml.storage import MediaFilesStorage; MediaFilesStorage().save('file.txt',StringIO('dkkdkd'))
...
# Login into minio and create bucket called aml-media

export AWS_ACCESS_KEY_ID=2Q87EJPVQ0739BYNXMGH;export AWS_SECRET_ACCESS_KEY=UmjiZ8qnNqGSexo49yVcJmzaJ1x835/na0TcIFFa;export DEFAULT_MEDIA_FILE_STORAGE=aml.storage.MediaS3Storage

Under MediaS3Storage in aml/storage.py uncomment endpoint_url
